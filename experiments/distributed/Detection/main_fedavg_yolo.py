...
from data_preprocessing.coco.dectection.data_loader import load_partition_data_coco
...
if __name__ == '__main__':
    ...
    #         name="FedAVG(d)" + str(opt.partition_method) + "r" + str(opt.comm_round) + "-e" + str(
    #             opt.epochs) + "-lr" + str(opt.lr),
    #         config=opt
    #     )
